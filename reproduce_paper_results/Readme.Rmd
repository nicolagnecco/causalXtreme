...
The required R packages are: `causalXtreme`, `tidyverse`, `doParallel`, `doRNG`,
`rngtools`, `tictoc`, `latex2exp`, `tools`, `mthemer` (installable from [https://rdrr.io/github/cszang/mthemer/man/mthemer.html]), and `kableExtra`.
