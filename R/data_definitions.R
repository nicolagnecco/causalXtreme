...
# dag is binary_matrix that can be made strictly upper triangular
...
# adjacency_matrix is numeric_matrix that can be made strictly upper triangular
...
# coeff_matrix is numeric_matrix that can be made strictly upper triangular
