function [ ltrBs, times, mycputimes, Fnorms ] = plotspwDling
...
%
% Before using this function, download pairwise LiNGAM code from
% "http://www.cs.helsinki.fi/u/ahyvarin/code/pwcausal/", extract the files,
...
for dims = testdims,
    ...
    testsamples = [100 200 500 1000 ] % sample size
        ...
        for itests = 1:ntests,
            ...
            switch method
                ...
                case 'pwDling'
                    ...
                    [Best, stde, ci, k] = pwDling(X, 'pk', Mp);
...
switch method
    case 'pwDling'
        disp('Pairwise LiNGAM in the DirectLiNGAM framework');
    case 'ICA-LiNGAM'
        disp('ICA-LiNGAM');
end
